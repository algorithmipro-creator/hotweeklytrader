CREATE TABLE "PeriodPayoutRegistry" (
...
CREATE TABLE "PeriodPayoutRegistryItem" (
...
CREATE INDEX "PeriodPayoutRegistry_investment_period_id_idx"
  ON "PeriodPayoutRegistry" ("investment_period_id");

CREATE INDEX "PeriodPayoutRegistry_settlement_snapshot_id_idx"
  ON "PeriodPayoutRegistry" ("settlement_snapshot_id");

CREATE INDEX "PeriodPayoutRegistry_generated_at_idx"
  ON "PeriodPayoutRegistry" ("generated_at");

CREATE INDEX "PeriodPayoutRegistryItem_payout_registry_id_idx"
  ON "PeriodPayoutRegistryItem" ("payout_registry_id");

CREATE INDEX "PeriodPayoutRegistryItem_deposit_id_idx"
  ON "PeriodPayoutRegistryItem" ("deposit_id");

CREATE INDEX "PeriodPayoutRegistryItem_network_idx"
  ON "PeriodPayoutRegistryItem" ("network");

CREATE INDEX "PeriodPayoutRegistryItem_status_idx"
