DO $$
BEGIN
  IF to_regclass('"InvestmentPeriod"') IS NOT NULL THEN
    CREATE TABLE IF NOT EXISTS "PeriodSettlementSnapshot" (
...
DO $$
BEGIN
  IF to_regclass('"PeriodSettlementSnapshot"') IS NOT NULL THEN
    CREATE INDEX IF NOT EXISTS "PeriodSettlementSnapshot_investment_period_id_idx"
      ON "PeriodSettlementSnapshot" ("investment_period_id");
    CREATE INDEX IF NOT EXISTS "PeriodSettlementSnapshot_approved_at_idx"
