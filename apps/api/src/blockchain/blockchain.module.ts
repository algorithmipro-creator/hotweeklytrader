...
@Module({
  ...
  providers: [BlockchainService, BscScanWatcherService, TronUsdtWatcherService, TonUsdtWatcherService],
  exports: [BlockchainService, BscScanWatcherService, TronUsdtWatcherService, TonUsdtWatcherService],
})
