    ...
    <AppScreen>
      <div className="relative z-10 rounded-3xl border border-cyan-300/15 bg-slate-950/60 p-5 shadow-[0_20px_50px_rgba(0,0,0,0.35)]">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm font-semibold uppercase tracking-[0.18em] text-cyan-200/70">{t('addresses.kicker')}</div>
          </div>
      ...
      <div className="relative z-10 mt-4 space-y-4">
        <header className="rounded-2xl bg-bg-secondary p-5">
          <p className="text-xs uppercase tracking-[0.18em] text-text-secondary">{t('addresses.kicker')}</p>
          <h1 className="mt-2 text-2xl font-bold">{t('addresses.title')}</h1>
          <p className="mt-2 text-sm text-text-secondary">{t('addresses.subtitle')}</p>
        </header>
