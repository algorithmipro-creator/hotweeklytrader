      ...
      <div className="relative z-10 rounded-3xl border border-cyan-300/15 bg-slate-950/60 p-5 shadow-[0_20px_50px_rgba(0,0,0,0.35)]">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="text-[11px] uppercase tracking-[0.2em] text-cyan-200/70">{t('profile.referralsTitle')}</div>
              <h1 className="mt-2 text-2xl font-bold text-slate-50">{t('referrals.title')}</h1>
            </div>
          </div>
        ...
        <p className="mt-3 text-sm text-slate-400">{t('referrals.subtitle')}</p>
      </div>
